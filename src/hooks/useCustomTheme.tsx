    ...
    () =>
      createTheme({
        ...
        typography: {
          ...
          subtitle2: buildVariant(fontWeightLight, 16, 1.57, 0.1),
          body1: buildVariant(fontWeightRegular, 18, 1.2, 0.15),
          body2: buildVariant(fontWeightRegular, 16, 1.2, 0.15),
          button: buildVariant(fontWeightBold, 18, 1, 0.4, caseAllCaps),
          caption: buildVariant(fontWeightRegular, 16, 1, 0.4),
          overline: buildVariant(fontWeightRegular, 16, 2.66, 1),
        },
        transitions: {
          easing: {
